...
export type TAutocompleteTagProps = IAutocompleteTagOwnProps &
...
export const AutocompleteTag = React.forwardRef<HTMLDivElement, TAutocompleteTagProps>(
  (props, ref) => {
    const { children, startContent: startContentProp, onDelete, ...other } = props;
    ...
    const startContent = startContentProp && (
      <AutocompleteTagStartContent>{startContentProp}</AutocompleteTagStartContent>
    );
