...
import { renderWithWrapper as render, screen, userEvent, fireEvent } from '../test-utils';
...
describe('<Checkbox />', () => {
  ...
  describe('Checkbox render colors', () => {
    const colors: React.ComponentProps<typeof Checkbox>['color'][] = ['primary', 'secondary'];
