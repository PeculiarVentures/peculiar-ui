import{j as n}from"./jsx-runtime-DtaoT6pD.js";import{r as _}from"./index-OjgoNOWw.js";import{n as k}from"./emotion-styled.browser.esm-jsqElTi7.js";import{B as o}from"./box-bq1vF_Hs.js";const C=/^(as|direction|wrap|gap|align|justify)$/,V=k("div",{shouldForwardProp:e=>!C.test(e)})(e=>({minWidth:"0px",...e.size==="auto"&&{flex:"0 0 auto",maxWidth:"none",width:"auto"},...e.size==="grow"&&{flexBasis:"0px",flexGrow:1,maxWidth:"100%"},...!e.size&&{flexGrow:0,flexBasis:"auto"}})),a=_.forwardRef((e,c)=>{const{component:d,...u}=e,p=d||"div";return n.jsx(V,{as:p,ref:c,...u})});a.displayName="Flex";a.defaultProps={};try{a.displayName="Flex",a.__docgenInfo={description:"",displayName:"Flex",props:{component:{defaultValue:null,description:`The component used for the root node.
